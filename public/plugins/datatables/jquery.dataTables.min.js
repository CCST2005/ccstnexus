...
(function(l) {
    ...
    function Kb(a) {
        var b =
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            f = '<input type="search" id="dataTablesInput" oninput="searchValues = this.value" class="' + b.sFilterInput + '"/>',
            g = d.sSearch;
    ...
    function Yb(a, b) {
        var searchings = searchValues;
        var c = a.fnFormatNumber,
            d = a._iDisplayStart + 1,
            e = a._iDisplayLength,
            h = a.fnRecordsDisplay(),
            f = -1 === e;
        return b.replace(/_SEARCH_/g, searchings).replace(/_START_/g, c.call(a, d)).replace(/_END_/g, c.call(a, a.fnDisplayEnd())).replace(/_MAX_/g, c.call(a, a.fnRecordsTotal())).replace(/_TOTAL_/g, c.call(a, h)).replace(/_PAGE_/g, c.call(a, f ? 1 : Math.ceil(d / e))).replace(/_PAGES_/g,
    ...
    function Jb(a) {
        ...
        // Add the option with the value "500"
        e[0][g] = new Option("500", 500);
        e[0][g+1] = new Option("1000", 1000);
        e[0][g+2] = new Option("All", 1000000000);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<span style='color:gray'>No data found.</span>",
            sInfo: "Displaying _START_ - _END_ of _TOTAL_ data entries",
            sInfoEmpty: "0 data entries",
            sInfoFiltered: "(Result for: \"_SEARCH_\")",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
