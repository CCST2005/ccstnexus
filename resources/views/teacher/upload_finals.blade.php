...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Upload final grades</h1>
            ...
            <div class="card">
              ...
              <div style="display:none !important; width: 100%; display:flex; justify-content: end; margin-bottom:10px"><button type="button" class="btn bg-gradient-info" id="" onclick="uploads();"><i class="fas fa-file-upload"></i> Import grades</button></div>
                ...
                function checkColor(id){
                    ...
                    if(inputGrade.value != '' ){
                        ...
                        else if(inputGrade.value >= 97.5)
                        {
                            eqv = '1.0';
                        }
                        else if(inputGrade.value >= 94.5)
                        {
                            eqv = '1.25';
                        }
                        else if(inputGrade.value >= 91.5)
                        {
                            eqv = '1.50';
                        }
                        else if(inputGrade.value >= 87.5)
                        {
                            eqv = '1.75';
                        }
                        else if(inputGrade.value >= 84.5)
                        {
                            eqv = '2.00';
                        }
                        else if(inputGrade.value >= 81.5)
                        {
                            eqv = '2.25';
                        }
                        else if(inputGrade.value >= 78.5)
                        {
                            eqv = '2.50';
                        }
                        else if(inputGrade.value >= 75.5)
                        {
                            eqv = '2.75';
                        }
                        else if(inputGrade.value >= 74.5)
                        {
                            eqv = '3.00';
                        }
              ...
              <table id="example3" class="table-bordered table table-bordered table-striped">
                ...
                @php
                    ...
                    @php
                        if ($valuesGrade == '' || $valuesGrade == '0' && $dones != '1') {
                           
                            $colors = "width: 100px; border-color: rgb(240, 64, 64)";
                            $type = "text";
                            if( $valuesGrade == '0'  && $dones != '1'){
                  ...
                  <tr id="{{$data->id}}row" class="opacitysTR" >
                      ...
                      <td>
                            ...
                            <div style="position:relative; width: 100%; height: 100%;">
                                ...
                                <input {{$readonly}} max="100" type="number"  name="{{$data->id}}inputGrade" step="any" id="{{$data->id}}inputGrade" onchange="limitInput(this, 60, 100, '{{$data->id}}')" onkeyup="checkColor('{{$data->id}}');"  style="{{$colors}}" class="form-control" value="{{$valuesGrade}}"  placeholder="00.00">
                      ...
                      <td><label id="{{$data->id}}eqv"></label></td>
                      <td><label id="{{$data->id}}remarksTag"></label></td>
            ...
            <div class="card-body" style="padding-left: 0px">
                ...
                <div class="d-flex gap-flex"  style="flex-wrap: wrap-reverse;justify-content: space-between">
                    <div class="d-flex gap-flex" style="flex-wrap: wrap">
                        <button type="button" class="btn bg-gradient-secondary" id="submit_button"  onclick="askfirst()">Back</button>
                        @if($ditTable == '1')
                        <button type="button" class="btn bg-gradient-success" id="submit_buttons" onclick="validateForm();">Save & mark as done</button>
                        @endif
                    </div>
