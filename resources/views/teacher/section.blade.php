          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title"><a href="{{ route('teacher.add_section', ['department' => $departmentID ]) }}"><button class="btn btn-block bg-gradient-primary">Add section</button></a></h3>
                      ...
                      @endif
                          ...
                          <td>
                            <div class="d-flex gap-flex">
                              <a class="update a_gray"   title="Edit" href="{{ route('teacher.update_section', ['id' => $data->id ]) }}">
                                <i class="fas fa-pencil-alt"></i>
                              </a>
                              
                              <a class="update a_gray"   title="Delete" onclick="deleting_admin({{$data->id}}, 'Your password');deletingValsWarn()">
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    function checkingTrues(password, id){
      ...
      if(password != 'false'){
        ...
        var newPageURL = "{{ route('teacher.delete_section', ['id' => 'PLACEHOLDER_ID', 'password' => 'PLACEHOLDER_PASS', 'department' => 'PLACEHOLDER_DEPT']) }}"
