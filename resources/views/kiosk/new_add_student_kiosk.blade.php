...
<div class="content-wrapper" style="margin:0px !important;padding:0px !important;">
...
@endif
              ...
              <form id="myForm" method="POST" action="{{ route('kiosk.adding_student_kiosk') }}">
              <br>
<br>
                <div class="card-body">
                <h1 style="margin:0px;padding:0px;text-shadow: 3px 3px 7px rgba(0, 0, 0, .5);"><b>CCST REGISTRATION KIOSK (STEP 3)</b></h1>
                <h4 style="text-shadow: 3px 3px 7px rgba(0, 0, 0, .5);">NEW ENROLLEE</h4>
                <br><br>
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="validateInput(this)" class="form-control" id="student_no" value="05-" name="student_no" placeholder="Student no.">
                            </div>
                        </div>
                        <script>
                            function validateInput(input) {
                                input.value = input.value.replace(/[^0-9-]/g, '');
                                if(input.value[2] !== "-" && input.value.length > 2) {
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="last_name">Contact No.<sup class="sup">*</sup></label>
                                <input type="text" class="form-control" id="econtact" name="econtact" placeholder="Contact No.">
                            </div>
                        </div>
                    ...
                    function validateForm_second(checking) {
                        ...
                        if(  
                            ...
                            if (!first_name || first_name.length < 2 || first_name.length > 90 || !namePattern.test(first_name)) {
                                ...
                                modals("The barangay should have a minimum of 2 characters and a maximum of 90 characters.");
                                markAsInvalid(barangay_text);
                                isValid = false;
                            } else if (!house || house.length < 2 || house.length > 90) {
                                house = document.getElementById('house');
                                modals("The House number/Street should have a minimum of 2 characters and a maximum of 90 characters.");
                                markAsInvalid(house);
                                isValid = false;
                                ...
                                modals("Student's contact number should be 11 digits.");
                                ...
                                econtact = document.getElementById('contact_student');
                                modals("Guardian's contact number should be 11 digits.");
                                markAsInvalid(econtact);
                                isValid = false;
                            }
