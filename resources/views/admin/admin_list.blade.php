          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title"><a href="{{ route('admin.add_admin') }}"><button class="btn btn-block bg-gradient-primary">Add account</button></a></h3>
              ...
              <div class="card-body">
                <table id="example3" class="table table-bordered table-striped">
                    ...
                    @if($data->owner_id != session('user_logged'))
                      @if($data->disabled == '1')
                      ...
                      <tr>
                      @endif
                          <td><input type="checkbox" name="checkboxes[]" onclick="updateCount(this)" value="{{ $data->owner_id }}"></td>
                          ...
                          <td>
                            <div class="d-flex gap-flex">
                              <a class="update a_gray"   title="Edit" href="{{ route('admin.update_admin', ['id' => $data->owner_id ]) }}">
                                <i class="fas fa-pencil-alt"></i>
                              </a>
                              
                              <a class="update a_gray"   title="Delete" onclick="deleting_admin({{$data->owner_id}}, 'Admin password')">
                                <i class="fas delete fa-trash-alt"></i> 
                              </a>
                              <a class="update a_gray"  title="{{$data->disabled == '0' ? 'Disable' : 'Enable'}}" href="{{ route('admin.disabling', ['id' => $data->owner_id ]) }}">
