...
@section('titlePage') CCSTNexus | teacher @endsection
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Teacher accounts</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title"><a href="{{ route('admin.add_teacher') }}"><button class="btn btn-block bg-gradient-primary">Add account</button></a></h3>
                      ...
                      @endif
                          ...
                          <td>
                            <div class="d-flex gap-flex">
                              <a class="update a_gray"   title="Edit" href="{{ route('admin.update_teacher', ['id' => $data->id ]) }}">
                              ...
                              <a class="update a_gray"  title="{{$data->disabled == '0' ? 'Disable' : 'Enable'}}" href="{{ route('admin.disabling_teacher', ['id' => $data->id ]) }}">
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    function checkingTrues(password, id){
      ...
      if(password != 'false'){
        ...
        var newPageURL = "{{ route('admin.delete_teacher', ['id' => 'PLACEHOLDER_ID', 'password' => 'PLACEHOLDER_PASS']) }}"
   ...
   function deletingAll(ids, password) {
        ...
        jQuery.ajax({
          ...
          url: "{{ url('admin/delete_multiple_teacher') }}",
          data: {
              password: password,
              id: ids,
          },
      ...
      function disablingAll(ids, password) {
        ...
        jQuery.ajax({
          ...
          url: "{{ url('admin/disable_multiple_teacher') }}",
          data: {
              password: password,
              id: ids,
          },
