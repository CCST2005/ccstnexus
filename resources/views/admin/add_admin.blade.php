            ...
            <div class="card">
              ...
              @csrf
                ...
                <div class="d-flex gap-flex">
                    <a href="{{ route('admin.index') }}"><button type="button" class="btn bg-gradient-secondary" id="submit_button" onclick="">Back</button></a>
                ...
                <script>
                    ...
                    function validateForm_second() {
                        ...
                        if(gmail != "" && employees != "" && value != "" && value2 != "" && email.value != "" && password.value != "" && confirmPassword.value != ""){
