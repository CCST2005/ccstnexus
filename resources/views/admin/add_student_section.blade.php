...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Choose section </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="display:flex; justify-content:space-between; width: 100%"><span>Please choose section</span> <span>S.Y. {{$acads}}</span></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="card-body">
              <form id="myForm" method="GET" action="{{ route('admin.sectioning_student') }}">
              @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select  class="custom-select" onchange="fill_strand();changinging();" id="track" name="track">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select class="custom-select"  onchange="fill_strand();changinging()" id="semester" name="semester">
                    ...
                    <script>
                            ...
                            const Descriptionss = [
                                @foreach($subject as $subjects)
                                    '{{$subjects->sub_code}} - {{$subjects->title}}',
                                @endforeach
                            ];
                    ...
                    const Descriptions = [];
                        ...
                        function fill_strand(){
                            var level = document.getElementById('track');
                        var sems = document.getElementById('semester');
                        var strandss =  document.getElementById('sections');
                     
                        jQuery.ajax({
                            
                                            
                            url: "{{ url('admin/gettingSectionTeacher') }}",
                            data: {
