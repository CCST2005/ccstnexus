...
@section('titlePage') CCSTNexus | departments @endsection
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title"><a href="{{ route('admin.add_departments') }}"><button class="btn btn-block bg-gradient-primary">Add department</button></a></h3>
                
              </div>
              <form id="checkboxForm">
                  @csrf
              <div class="card-header" style="display:none" id="disable&delete" >
                  <div><span style="opacity:80%">Selected department: <span id="countSelected"></span></span></div>
                      ...
                      @endif
                          ...
                          <td>
                            <div class="d-flex gap-flex">
                              <a class="update a_gray"   title="Edit" href="{{ route('admin.update_department', ['id' => $data->id ]) }}">
  ...
  $('[data-toggle="tooltip"]').tooltip()
    ...
    function checkingTrues(password, id){
      ...
      if(password != 'false'){
        ...
        var newPageURL = "{{ route('admin.delete_department', ['id' => 'PLACEHOLDER_ID', 'password' => 'PLACEHOLDER_PASS']) }}"
   ...
   function deletingAll(ids, password) {
        ...
        jQuery.ajax({
          ...
          url: "{{ url('admin/delete_multiple_department') }}",
          data: {
              password: password,
              id: ids,
          },
