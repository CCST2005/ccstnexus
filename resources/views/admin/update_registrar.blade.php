        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
              <div class="card-body">
              <form id="myForm" method="POST" action="{{ route('admin.updating_registrar', ['id' => $finding_user_acc->id]) }}">
              @csrf
                <div class="row">
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" onchange="changeNameselect()" onkeypress="changeNameselect()"  id="first_name" name="first_name" placeholder="First name" value="{{ (empty($finding_user_acc->firstname)) ? 'N/A' : $finding_user_acc->firstname }}">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="tags_input" name="roles[]" id="roles" multiple>
                                ...
                                @foreach($rolesListForregistrar as $roles)
                                    ...
                                    @foreach($roles_registrar as $roles_registrarr)
                                        @if($roles_registrarr->role == $roles->role)
                ...
                <div class="d-flex gap-flex">
                    <a href="{{ route('admin.registrar') }}"><button type="button" class="btn bg-gradient-secondary" id="submit_buttons" onclick="">Back</button></a>
                ...
                <script>
                    ...
                    function validateForm(){
                        ...
                        jQuery.ajax({
                                    ...
                                    url: "{{ url('admin/checkIfRegistrarExist') }}",
                                    data: {
                    ...
                    function validateForm_second() {
                        ...
                        if(gmail != "" && employees != "" && value != "" && value2 != "" && email.value != "" && selectedValues != ""  ){
