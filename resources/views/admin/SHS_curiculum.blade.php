...
@section('titlePage') CCSTNexus | SHS curriculum @endsection
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">SHS curriculum</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title"><a href="{{ route('admin.add_shs_curriculum') }}"><button class="btn btn-block bg-gradient-primary">Add curriculum</button></a></h3>
