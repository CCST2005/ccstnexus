          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Update section from {{ $departments }}</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="card-body">
              <form id="myForm" method="POST" action="{{ route('admin.updating_section', ['id' => $existingEmployee->id]) }}" enctype="multipart/form-data">
              @csrf
                <input type="hidden" class="form-control" id="idDept" name="idDept" placeholder="" value="{{$idDept}}">
                <div class="row">
                <input type="hidden" name="track" id="track" class="form-control" value="{{ $existingEmployee->track }}">
                <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="semester" name="semester">
                                    ...
                                    @php
                                            ...
                                            if( $existingEmployee->semester == 1 ){
                                                $semester1 = 'selected';
                                                $semester2 = '';
                                            }
                                            else{
                                    ...
                                    @endphp
                                    <option {{$semester1}} value="1">1st semester</option>
                                    <option {{$semester2}} value="2">2nd semester</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" value="{{ $tracksName }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ $existingEmployee->section }}" placeholder="Section code">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="desc" name="desc" value="{{ $existingEmployee->desc }}" placeholder="Description">
                        </div>
                    </div>
                ...
                <div class="d-flex gap-flex">
                    ...
                    <button type="button" class="btn bg-gradient-success" id="submit_buttons" onclick="validateForm();">Update section</button>
                ...
                <script>
                    ...
                    function validateForm_second() {
                        ...
                        var currentTitle = "{{ $existingEmployee->section }}";

                     

                        if( title.value != "" && adviser.value != ""){
                            ...
                            else if(emailExists && title.value != currentTitle){
                                markAsInvalid(title);
