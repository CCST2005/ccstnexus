...
@endif
              ...
              <form id="myForm" method="POST" action="{{ route('admin.updating_student', ['id' => $finding_user_acc->id]) }}">
                    ...
                    <div class="row" >
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="validateInput(this)" class="form-control" value="{{ $finding_user_acc->student_no }}" id="student_no" name="student_no" placeholder="Employee no.">
                            </div>
                        </div>
                        <script>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="{{ $finding_user_acc->firstname }}" id="first_name" onkeyup="changeNameselect()" name="first_name" placeholder="First name">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="{{ $finding_user_acc->lastname }}" id="last_name" name="last_name" placeholder="Last name">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select" onchange="levels(this)"  id="level" name="level">
                                    ...
                                    <option {{($level == '11') ? 'selected' : '' }} value="11">11</option>
                                    <option  {{($level == '12') ? 'selected' : '' }}  value="12">12</option>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="last_name" > <span id="strandName">Academic program</span> <sup class="sup">*</sup></label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <span onclick="resets()" id="reseting" class="resets">Reset address</span>
                            </div>
                            <script>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $finding_user_acc->ContactNo }}"  id="contact_student" name="contact_student" placeholder="Contact No.">
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="last_name">Contact No.<sup class="sup">*</sup></label>
                                <input type="text" class="form-control" id="econtact"value="{{ $finding_user_acc->emergency_contact }}"  name="econtact" placeholder="Address">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="input-group">
                            ...
                            <script>
                                ...
                                var currentEnds = '{{ (empty($previous->elementaryYr)) ? "" : $previous->elementaryYr }}';
                                var yearsPass ="";
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-flex">
                        <a href="{{ route('admin.student') }}"><button type="button" class="btn bg-gradient-secondary" id="submit_button" onclick="">Back</button></a>
...
@endif
  ...
  <script>          var id_admin = '{{ $finding_user_acc->id }}';
                    ...
                    fill_strand('{{$finding_user_acc->level}}');
                    ...
                    function validateForm_second(checking) {
                        ...
                        if(  
                            ...
                            if(password.value.trim() != "" && password.value.trim().length < 8){
                                ...
                                modals("Password must have 8 characters and above.");
                                markAsInvalid(password);
                                isValid = false;
                            }

                            
                            if(password.value.trim() != "" && password.value.trim() != confirm_password.value.trim()){
