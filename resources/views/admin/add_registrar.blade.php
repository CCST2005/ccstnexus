          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Add registrar account</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="card-body">
              <form id="myForm" method="POST" action="{{ route('admin.adding_registrar') }}">
              @csrf
                <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="d-flex gap-flex">
                    <a href="{{ route('admin.registrar') }}"><button type="button" class="btn bg-gradient-secondary" id="submit_button" onclick="">Back</button></a>
                ...
                <script>
                    ...
                    function validateForm_second() {
                        ...
                        if(gmail != "" && employees != "" && value != "" && value2 != "" && email.value != "" && selectedValues != "" && password.value != "" && confirmPassword.value != ""){
